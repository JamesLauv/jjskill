---
name: jjskill
description: Personal work artifact router for James/JJ. Use when the user provides project materials, meeting notes, customer requirements, sales/pre-sales content, technical evaluations, internal communication drafts, or scattered business documents and asks to 整理, 分析, 帮我看看, 做成沟通材料, 生成决策材料, 推进表, 方案对比, 汇报材料, demo测试, 测试脚本, 对话模拟, 流程图标注, 选择输出格式, or route the work to the right jjskill-* workflow.
---
...
用于从客户提供的业务文档中提取业务规则，生成智能客服Demo的完整测试框架。

适用场景：

- 客户资料分析（PPT培训材料、操作流程文档、业务规则说明）
- 智能客服Demo测试脚本、测试用例矩阵
- 退货/问答/订单等业务场景对话模拟
- WEB端对话窗口模拟（HTML交互页面）
- 业务流程图（含技术节点标注：API/KB/Rules/UI）
- 对话内容技术备注表（Excel）
- 测试用例跟踪表
- POC测试准备、Demo演示脚本

关键区别：
- jjskill-doc-to-decision-artifacts → 方案评估、会议推进、决策材料
- jjskill-demo-test-framework → Demo测试框架、对话模拟、技术节点标注
